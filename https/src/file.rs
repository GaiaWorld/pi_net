        ...
        Err(e) => {
            match e {
                ...
                _ => {
                    ...
                    println!("!!!> Https Async Load File Error, task wakeup failed, task id: {}, err: {:?}, e: {:?}", req.uid, err, e)
                },
            }
        },
        Ok(waker) => {
        ...
        Err(e) => {
            match e {
                ...
                _ => {
                    ...
                    println!("!!!> Https Async Load File Ok, task wakeup failed, task id: {}, e: {:?}", req.uid, e)
                },
            }
        },
        Ok(waker) => {
